...
where,\\
X=0 refers to the event when \pr{A+B}=16\\
X=1 refers to the event when \pr{A+B}\neq 16\\

Now, probability of selecting an element from set A such that \pr{A+B}=16 is 1.\\

So,the probability of selecting an element from set B after selecting an element from set A such that \pr{A+B}=16 is 1/5.\\

Therefore,\\
Overall probability of randomly choosing elements from set A and set B such that \pr{A+B}=16 is 1\times1/5=1/5=0.2\\
