...
Since, two numbers are randomly selected, one from each set.\\
...
The set with the favourable outcomes of two numbers randomly selected such that the sum of the two numbers is 16 is \\

\begin{bmatrix}
(2,14)&(3,13)&(4,12)&(5,11)
\end{bmatrix}\\

Therefore, favourable outcomes=4\\

So,\\
The probability that the sum of the two numbers equals 16
\begin{equation}
\tag{7.1}
&=&\frac{\mbox{favourable outcomes}}{\mbox{sample space}}
&=&\frac{4}{20}
&=&0.20 
\end{equation}
