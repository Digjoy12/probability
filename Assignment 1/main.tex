...
\end{align*}
 Now,we need to find \pr{\mbox{A fails alone}}=\pr{A-B}
\begin{enumerate}
\item
\begin{align}
    \tag{6.7.1}
    ...
    \implies \pr{A-B}&=0.05
\end{align}
Therefore, \pr{\mbox{A fails alone}}=\pr{A-B}=0.05\\
\item
...
\begin{align}
    ...
    \implies \pr{B}&=0.30
\end{align}
Now, we need to find \pr{\mbox{A fails$|$B has failed}}=\pr{A|B}\\
\begin{align}
    \tag{6.7.9}
    ...
    \implies \pr{A|B}&=0.5
\end{align}
Therefore, \pr{\mbox{A fails$|$B has failed}}=\pr{A|B}=0.5\\
\end{enumerate}
\end{document}
